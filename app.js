...
(() => {
  ...
  function renderMap(data) {
    ...
    map=L.map('operational-map',{zoomControl:true,minZoom:3}).setView([-4.2,-61.5],5);
  ...
  function renderBorder(data) {
    ...
    $('#brazil-impact-data').innerHTML=dl([['Área brasileira',b.municipioBrasil],['Distância da fronteira',b.distanciaFronteira],['Bacia hidrográfica',b.bacia],['Eixo logístico',b.eixoLogistico],['Impacto potencial',b.impactoPotencial],['Risco de transbordamento',b.riscoTransbordamento]]);
  }
